...
const Dashboard = React.lazy(() => import('./views/dashboard/YoriDashboard'))
...
const NoticeInsert = React.lazy(() => import('./views/notice/NoticeInsert'))
const NoticeDetail = React.lazy(() => import('./views/notice/NoticeDetail'))

// 레시피 리스트
const IngredientList = React.lazy(() => import('./views/recipe/IngredientList'))
const KindList = React.lazy(() => import('./views/recipe/KindList'))
// 채널 리스트
const ChannelList = React.lazy(() => import('./views/channel/ChannelList'))
...
const routes = [
  ...
  { path: '/ingredient', name: 'Ingredient', component: IngredientList },
  { path: '/kind', name: 'Kind', component: KindList },
  { path: '/channel', name: 'Channel', component: ChannelList },
  { path: '/yoridashboard', name: 'YoriDashboard', component: YoriDashboard },
]
